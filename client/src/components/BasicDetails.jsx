...
const BasicDetails = (({ type, vicinity, priceLevel }) => (
  <div id="overview-basic-details">
    <div className="overview-basic-details-specific">{type}<span className="overview-middot">·</span></div>
    <div className="overview-basic-details-specific">{vicinity}<span className="overview-middot">·</span></div>
